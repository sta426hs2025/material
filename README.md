...
[Dr. Pierre-Luc Germain](https://ins.ethz.ch/people/person-detail.MjUwODk0.TGlzdC8yOTEzLC0xODk3MzAwNjU1.html), Lecturer, [Department of Health Sciences and Technology](https://ins.ethz.ch/), ETHZ
...
| 27.10.2025  | Mark | edgeR+friends 1 | basic edgeR/voom | [Analysis of multi-condition single-cell data with latent embedding multivariate regression](https://www.nature.com/articles/s41588-024-01996-0) (AM, AL, AC)| [GECSI: Large-scale chromatin state imputation from gene expression](https://www.biorxiv.org/content/10.1101/2025.10.02.679828v1) (ES, GC, NM) |
| 03.11.2025  | Mark | edgeR+friends 2 | advanced edgeR/voom | [Gene set enrichment analysis: A knowledge-based approach for interpreting genome-wide expression profiles](https://www.pnas.org/doi/10.1073/pnas.0506580102) (NH, HQ) | [voom: precision weights unlock linear model analysis tools for RNA-seq read counts](https://genomebiology.biomedcentral.com/articles/10.1186/gb-2014-15-2-r29) (TH, JB)|
